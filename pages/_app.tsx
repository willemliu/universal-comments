        ...
        <>
            <Head>
                ...
                <meta
                    ...
                    content="default-src *; img-src * data:; style-src * 'unsafe-inline'; script-src 'self' https://connect.facebook.net/en_US/sdk.js https://apis.google.com/js/platform.js 'unsafe-inline' 'unsafe-eval';"
                />
